...
insert into rooms(capacity,full_day_price,half_day_price,hour_price,name,status) values(15,2000,1200,400,'room2',1);
insert into rooms(capacity,full_day_price,half_day_price,hour_price,name,status) values(20,3000,1800,600,'room3',1);
...
insert into bookings (booking_date,from_date,status,to_date,type,client_fk,layout_fk,room_fk,amount) values ('2018-08-07 07:34:09','2018-08-07 10:00:00',1,'2018-08-07 13:00:00',1,'tanya@visa.com',1,1,1000);
insert into bookings (booking_date,from_date,status,to_date,type,client_fk,layout_fk,room_fk,amount) values ('2018-08-06 19:59:09','2018-08-07 15:00:00',1,'2018-08-07 18:00:00',1,'tanya@visa.com',1,2,1500);
insert into bookings (booking_date,from_date,status,to_date,type,client_fk,layout_fk,room_fk,amount) values ('2018-08-07 07:39:09','2018-08-08 10:00:00',2,'2018-08-07 14:00:00',2,'ayush@visa.com',2,1,2000);
